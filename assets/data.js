...
const Units = [
  ...
  //USD arbitrarily set as basic unit. Reference to this unit is harcoded in currency loading!
  {
    ...
    id: "USD",
    alias: ["$", "usd"],
    name: { cz: "americký dolar", en: "US dollar" },
    k: 1,
    basic: true,
    prefix: "+",
  },
  ...
  //SI derived
  {
    v: [0, 0, 0, 0, 0, 0, 0, 0],
    id: "%",
    name: { cz: "procento", en: "percent" },
    k: 1e-2,
  },
  {
    v: [0, 0, 0, 0, 0, 0, 0, 0],
    id: "ppm",
    name: { cz: "dílů na jeden milion", en: "parts per million" },
    k: 1e-6,
  },
  {
    v: [0, 0, 0, 0, 0, 0, 0, 0],
    id: "rad",
    name: { cz: "radián", en: "radian" },
    k: 1,
    SI: true,
    prefix: "-",
    note: {
  ...
  },
  {
    ...
    id: "°",
    alias: ["deg"],
    name: { cz: "stupeň", en: "degree" },
    k: Math.PI / 180,
  },
  {
    v: [0, 0, 0, 0, 0, 0, 0, 0],
    id: "gon",
    name: { cz: "gradián", en: "gradian" },
    k: Math.PI / 200,
  },
  {
    v: [0, 0, -1, 0, 0, 0, 0, 0],
    id: "Hz",
    name: { cz: "hertz", en: "hertz" },
    k: 1,
    SI: true,
    prefix: "all",
  },
  ...
  },
  {
    v: [0, 0, 0, 0, 1, 0, 0, 0],
    id: "°C",
    name: { cz: "stupeň Celsia", en: "degree Celsius" },
    k: 1,
    SI: true,
    note: {
  ...
  },
  {
    v: [0, 0, -1, 0, 0, 0, 0, 0],
    id: "Bq",
    name: { cz: "becquerel", en: "becquerel" },
    k: 1,
    SI: true,
    prefix: "all",
  },
  {
    v: [0, 0, -1, 0, 0, 0, 0, 0],
    id: "Rd",
    name: { cz: "rutherford", en: "rutherford" },
    k: 1e6,
    SI: true,
    prefix: "all",
  },
  ...
  //non-SI
  {
    ...
    id: "Nm3",
    alias: ["Ncm"],
    name: { cz: "normální krychlový metr", en: "normal cubic metre" },
    k: csts.atm / csts.TC0 / csts.R,
    note: {
  ...
  },
  {
    ...
    id: "Ndm3",
    alias: ["Nl"],
    name: { cz: "normální litr", en: "normal litre" },
    k: csts.atm / csts.TC0 / csts.R / 1000,
    note: { cz: "Viz Nm3 pro vysvětlení.", en: "See Nm3 for explanation." },
  },
  {
    v: [0, 0, 0, 0, 0, 1, 0, 0],
    id: "SCF",
    name: { cz: "normální krychlová stopa", en: "standard cubic foot" },
    k: (0.028317 * csts.atm) / 288.7 / csts.R,
    note: { cz: "Viz Nm3 pro vysvětlení.", en: "See Nm3 for explanation." },
  },

  {
    v: [0, 0, 1, 0, 0, 0, 0, 0],
    id: "min",
    name: { cz: "minuta", en: "minute" },
    k: 60,
  },
  {
    v: [0, 0, 1, 0, 0, 0, 0, 0],
    id: "h",
    name: { cz: "hodina", en: "hour" },
    k: 3600,
  },
  {
    v: [0, 0, 1, 0, 0, 0, 0, 0],
  ...
  },
  {
    v: [0, 0, 1, 0, 0, 0, 0, 0],
    id: "week",
    name: { cz: "týden", en: "week" },
    k: 3600 * 24 * 7,
  },
  {
    v: [0, 0, 1, 0, 0, 0, 0, 0],
    id: "ftn",
    name: { cz: "dva týdny", en: "fortnight" },
    k: 1209600,
    prefix: "all",
  },
  {
    ...
    id: "month",
    alias: ["mth", "měs"],
    name: { cz: "průměrný měsíc", en: "average month" },
    k: 3600 * 24 * 30.436875,
    note: {
  ...
  },
  {
    ...
    id: "yr",
    alias: ["year"],
    name: { cz: "gregoriánský rok", en: "gregorian year" },
    k: 3600 * 24 * 365.2425,
    note: {
  ...
  },
  {
    v: [0, 0, 1, 0, 0, 0, 0, 0],
    id: "jyr",
    name: { cz: "juliánský rok", en: "julian year" },
    k: 3600 * 24 * 365.25,
  },

  {
    v: [0, 0, -1, 0, 0, 0, 0, 0],
    id: "rpm",
    name: { cz: "otáčky za minutu", en: "revolutions per minute" },
    k: 1 / 60,
  },

  {
    v: [0, 0, 0, 0, 1, 0, 0, 0],
    id: "°F",
    name: { cz: "stupeň Fahrenheita", en: "degree Fahrenheit" },
    k: 5 / 9,
    note: csts.dTnote,
  },
  {
    ...
    id: "°Re",
    alias: ["°Ré", "°r"],
    name: { cz: "stupeň Réaumura", en: "degree Réaumur" },
    k: 1.25,
    note: csts.dTnote,
  },
  {
  ...
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "th",
    name: { cz: "thou", en: "thou" },
    k: 2.54e-5,
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "in",
    name: { cz: "palec", en: "inch" },
    k: 2.54e-2,
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
  ...
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "yd",
    name: { cz: "yard", en: "yard" },
    k: 0.9144,
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "fur",
    name: { cz: "furlong", en: "furlong" },
    k: 201.168,
    prefix: "all",
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "mi",
    name: { cz: "míle", en: "mile" },
    k: csts.mile,
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "nmi",
    name: { cz: "námořní míle", en: "nautical mile" },
    k: 1852,
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "au",
    name: { cz: "astronomická jednotka", en: "astronomical unit" },
    k: 149597870700,
    prefix: "+",
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "pc",
    name: { cz: "parsek", en: "parsec" },
    k: 3.08567758149137e16,
    prefix: "+",
  },
  {
    v: [1, 0, 0, 0, 0, 0, 0, 0],
    id: "ly",
    name: { cz: "světelný rok", en: "light-year" },
    k: 9460730472580800,
    prefix: "+",
  },
  ...
  },
  {
    v: [3, 0, 0, 0, 0, 0, 0, 0],
    id: "pt",
    name: { cz: "pinta", en: "pint" },
    k: 568.261e-6,
  },
  {
    v: [3, 0, 0, 0, 0, 0, 0, 0],
    id: "gal",
    name: { cz: "americký galon", en: "US gallon" },
    k: 3.785412e-3,
  },
  {
    v: [3, 0, 0, 0, 0, 0, 0, 0],
    id: "bsh",
    name: { cz: "americký bušl", en: "US bushel" },
    k: 35.2391e-3,
  },
  {
    v: [3, 0, 0, 0, 0, 0, 0, 0],
    id: "ccm",
    name: { cz: "kubický centimetr", en: "cubic centimetr" },
    k: 1e-6,
  },
  {
    v: [3, 0, 0, 0, 0, 0, 0, 0],
    id: "bbl",
    name: { cz: "barel ropy", en: "oil barrel" },
    k: csts.bbl,
    prefix: "+",
  },

  {
    v: [3, 0, -1, 0, 0, 0, 0, 0],
    id: "BPD",
    name: { cz: "barel ropy za den", en: "oil barrel per day" },
    k: csts.bbl / 3600 / 24,
    prefix: "+",
  },
  ...
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "gr",
    name: { cz: "grain", en: "grain" },
    k: 64.79891e-6,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "oz",
    name: { cz: "once", en: "ounce" },
    k: 28.349523e-3,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "ozt",
    name: { cz: "trojská unce", en: "troy ounce" },
    k: 31.1034768e-3,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "ct",
    name: { cz: "karát", en: "carat" },
    k: 200e-6,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "lb",
    alias: ["lbs"],
    name: { cz: "libra", en: "pound" },
    k: 0.45359237,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "st",
    name: { cz: "kámen", en: "stone" },
    k: 6.35029318,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "slug",
    name: { cz: "slug", en: "slug" },
    k: 14.593903,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "fir",
    name: { cz: "firkin", en: "firkin" },
    k: 40.8233133,
    prefix: "all",
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "ts",
    name: { cz: "krátká tuna", en: "short ton" },
    k: 907.18474,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    id: "tl",
    name: { cz: "imperiální tuna", en: "long ton" },
    k: 1016,
  },
  {
    v: [0, 1, 0, 0, 0, 0, 0, 0],
    ...
    alias: ["Da"],
    name: {
      cz: "dalton (atomová hmotnostní konstanta)",
      en: "dalton (unified atomic mass unit)",
    },
    k: 1.66053904e-27,
  },

  {
    v: [1, 0, -1, 0, 0, 0, 0, 0],
    id: "mph",
    name: { cz: "míle za hodinu", en: "mile per hour" },
    k: csts.mile / 3600,
  },
  {
    v: [1, 0, -1, 0, 0, 0, 0, 0],
    id: "kn",
    name: { cz: "uzel", en: "knot" },
    k: 1852 / 3600,
  },
...

  {
    v: [2, 1, -2, 0, 0, 0, 0, 0],
    id: "Wh",
    name: { cz: "watthodina", en: "watt-hour" },
    k: 3600,
    prefix: "all",
  },
  {
    v: [2, 1, -2, 0, 0, 0, 0, 0],
    id: "eV",
    name: { cz: "elektronvolt", en: "electronvolt" },
    k: csts.q,
    prefix: "all",
  },
  {
  ...
  },
  {
    ...
    id: "Btu",
    alias: ["BTU", "btu"],
    name: { cz: "britská tepelná jednotka", en: "british thermal unit" },
    k: csts.BTU,
    prefix: "all",
  },
  {
    ...
    id: "Chu",
    alias: ["CHU", "chu"],
    name: { cz: "celsiova jednotka tepla", en: "celsius heat unit" },
    k: 1.899101e3,
    prefix: "all",
  },
  {
  ...
  },
  {
    v: [2, 1, -2, 0, 0, 0, 0, 0],
    id: "TNT",
    name: { cz: "ekvivalent tuny TNT", en: "ton of TNT equivalent" },
    k: 4.184e9,
    prefix: "+",
  },
  {
    ...
    id: "BOE",
    alias: ["BFOE"],
    name: { cz: "ekvivalent barelu ropy", en: "barrel of oil equivalent" },
    k: 5.8e6 * csts.BTU,
    prefix: "+",
  },
  {
    v: [2, 1, -2, 0, 0, 0, 0, 0],
    id: "GGE",
    name: { cz: "ekvivalent galonu benzínu", en: "gasoline gallon equivalent" },
    k: 114e3 * csts.BTU,
    prefix: "+",
  },
...

  {
    v: [2, 1, -3, 0, 0, 0, 0, 0],
    id: "hp",
    name: { cz: "imperiální koňská síla", en: "imperial horsepower" },
    k: 745.69987158227022,
  },

  {
    v: [-1, 1, -1, 0, 0, 0, 0, 0],
    id: "P",
    name: { cz: "poise", en: "poise" },
    k: 0.1,
    SI: true,
    prefix: "all",
  },
  ...
  },
  {
    v: [-1, 1, -2, 0, 0, 0, 0, 0],
    id: "atm",
    name: { cz: "atmosféra", en: "atmosphere" },
    k: csts.atm,
    note: {
  ...
  },
  {
    v: [-1, 1, -2, 0, 0, 0, 0, 0],
    id: "mmHg",
    name: { cz: "milimetr rtuťového sloupce", en: "milimetre of mercury" },
    k: 133.322387415,
    note: csts.Hgnote,
  },
  {
  ...
  },
  {
    v: [-1, 1, -2, 0, 0, 0, 0, 0],
    id: "psi",
    name: { cz: "libra na čtvereční palec", en: "pound per square inch" },
    k: 6894.757293168362,
    prefix: "all",
  },
  ...
  //constants
  {
    v: [1, 0, -2, 0, 0, 0, 0, 0],
    id: "_g",
    name: { cz: "normální tíhové zrychlení", en: "standard gravity" },
    k: 9.80665,
    constant: true,
    note: {
  ...
  },
  {
    v: [1, 0, -1, 0, 0, 0, 0, 0],
    id: "_c",
    name: { cz: "rychlost světla ve vakuu", en: "speed of light in vacuum" },
    k: 299792458,
    constant: true,
  },
  {
    v: [3, -1, -2, 0, 0, 0, 0, 0],
    id: "_G",
    name: { cz: "gravitační konstanta", en: "gravitational constant" },
    k: 6.67408e-11,
    constant: true,
  },
  {
    v: [2, 1, -1, 0, 0, 0, 0, 0],
    id: "_h",
    name: { cz: "Planckova konstanta", en: "Planck constant" },
    k: 6.62607004e-34,
    constant: true,
  },
  {
    v: [2, 1, -2, 0, -1, 0, 0, 0],
    id: "_k",
    name: { cz: "Boltzmannova konstanta", en: "Boltzmann constant" },
    k: 1.38064852e-23,
    constant: true,
  },
  {
    v: [2, 1, -2, 0, -1, -1, 0, 0],
    id: "_R",
    name: { cz: "plynová konstanta", en: "gas constant" },
    k: csts.R,
    constant: true,
  },
  {
    ...
    id: "_mu",
    alias: ["μ"],
    name: { cz: "permeabilita vakua", en: "vacuum permeability" },
    k: 1.2566370614e-6,
    constant: true,
  },
  {
    v: [-3, -1, 4, 2, 0, 0, 0, 0],
    id: "_E",
    name: { cz: "permitivita vakua", en: "vacuum permittivity" },
    k: 8.854187817e-12,
    constant: true,
  },
  {
    v: [0, 0, 1, 1, 0, 0, 0, 0],
    id: "_q",
    name: { cz: "elementární náboj", en: "elementary charge" },
    k: csts.q,
    constant: true,
  },
  {
    v: [0, 0, 0, 0, 0, -1, 0, 0],
    id: "_NA",
    name: { cz: "Avogadrova konstanta", en: "Avogadro constant" },
    k: 6.02214085e23,
    constant: true,
  },
  {
    ...
    id: "_pi",
    alias: ["π"],
    name: { cz: "Ludolfovo číslo", en: "Archimedes' constant" },
    k: Math.PI,
    constant: true,
  },
  {
    v: [0, 0, 0, 0, 0, 0, 0, 0],
    id: "_e",
    name: { cz: "Eulerovo číslo", en: "Euler's number" },
    k: Math.E,
    constant: true,
  },
  ...
  //special for Unitfuns, unusable without {}
  {
    ...
    id: "API",
    alias: ["°API"],
    name: { cz: "API hustota", en: "API density" },
    k: 1 / 141.5e3,
    onlyUnitfuns: true,
  }, //theoretically, without {} API = specific volume unit
  {
    v: [0, 0, 0, 0, 0, 0, 0, 0],
    id: "ln",
    alias: ["log"],
    name: { cz: "Přirozený logaritmus", en: "Natural logarithm" },
    k: NaN,
    onlyUnitfuns: true,
  },
];
...
const Currencies = [
  { id: "EUR", alias: ["€"], name: { cz: "euro", en: "Euro" } },
  {
    id: "AED",
    name: {
      cz: "dirham Spojených arabských emirátů",
  ...
  { id: "CNY", name: { cz: "čínský juan", en: "Chinese Yuan" } },
  {
    id: "CZK",
    alias: ["Kč"],
    name: { cz: "česká koruna", en: "Czech Republic Koruna" },
  },
  { id: "DKK", name: { cz: "dánská koruna", en: "Danish Krone" } },
  {
    id: "GBP",
    alias: ["£"],
    name: { cz: "britská libra", en: "British Pound Sterling" },
  },
